...
## Tools (247 public functions across 42 files)
...
- `async amazon_ads_performance_report` (line 475) — Run an Amazon Ads report deterministically and return a summary.
