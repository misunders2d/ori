...
## EvolutionToolset
- File: `app/toolsets/evolution.py:14`
- Groups all self-evolution tools: read, stage, verify, commit, git ops.
- Bundled tools: `check_installed_package`, `evolution_catalog`, `evolution_commit_and_push`, `evolution_git_branches`, `evolution_git_diff_file`, `evolution_git_diff_summary`, `evolution_git_fetch`, `evolution_git_log`, `evolution_git_pull`, `evolution_git_reset`, `evolution_import`, `evolution_list_directory`, `evolution_read_file`, `evolution_search`, `evolution_share`, `evolution_stage_change`, `evolution_sync_local_to_upstream`, `evolution_verify_sandbox`
...
## SystemToolset
- File: `app/toolsets/system.py:14`
