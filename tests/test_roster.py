"""Unit tests for app.core.roster — auto-populated user registry."""
...
def test_record_user_creates_entry(isolated_roster):
    ...
    assert e["last_seen"]  # ISO timestamp present
...
def test_load_handles_corrupt_file(isolated_roster, caplog):
