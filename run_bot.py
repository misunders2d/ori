...
# ---------------------------------------------------------------------------
# Environment loading — .env is READ-ONLY at runtime.
# Secrets (ADMIN_PASSCODE, A2A_API_KEY) are generated by launcher.sh before
# the container starts. Runtime config changes go to data/config.json via
# app.app_utils.runtime_config (atomic writes, immune to os._exit corruption).
# ---------------------------------------------------------------------------
...
# Merge runtime config (config.json) into os.environ — overrides .env values
from app.app_utils.runtime_config import load_config_into_env
