...
# Global system directive applied to every LLM call. Five core rules +
...
# `{admin_email}` is filled at injection time from the first email entry
# in ADMIN_USER_IDS (or "the admin" if no email admin is configured).
_SYSTEM_DIRECTIVE = (
