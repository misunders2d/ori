...
knowledge_agent = Agent(
    ...
    instruction=(
        ...
        "A2A COMMUNICATION:\n"
        "1. **Identity**: Use `get_agent_identity` to read this agent's public Agent Card. "
        "Use `get_my_a2a_key` to retrieve this agent's own API key (for sharing with friends who need to connect to us).\n"
