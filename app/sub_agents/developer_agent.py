...
developer_agent = Agent(
    ...
    instruction=(
        ...
        "The system will AUTOMATICALLY trigger a hard reboot (exit 100) after a successful commit — do NOT call `update_self` separately. "
        "The host supervisor will force-pull, rebuild, and restart.\n\n"
