...
root_agent = Agent(
    ...
    instruction=(
        ...
        "If the user asks for a complex task (e.g., 'evolve the code', 'fix this bug', 'research this library', 'evaluate DNA'), "
        ...
        "(Exception: For simple conversation, answering questions from existing memory, or checking schedules, answer directly).\n\n"
