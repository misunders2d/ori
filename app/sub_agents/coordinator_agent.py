...
root_agent = Agent(
    ...
    instruction=(
        ...
        "If the user also provides a 6-digit code (e.g., 'Approve ACT-XXXXXX 123456'), you MUST pass BOTH the token and the `totp_code` to the tool. "
        "Do NOT try to call the original tool again.\n\n"
