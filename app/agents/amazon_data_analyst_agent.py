"""Amazon Data Analyst sub-agent — statistical analysis, visualization, file exports.

Handles data analysis on large files (SP-API exports, BigQuery results, H10 keyword
exports), chart generation, file exports, and statistical operations.
"""
...
_data_analysis_skill = load_skill_from_dir(_SKILLS_DIR / "data-analysis-skill")
