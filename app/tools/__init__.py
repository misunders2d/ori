...
from .diagnostics import check_active_tasks, repair_data_permissions, report_health, inspect_secure_env
...
__all__ = [
    ...
    "check_active_tasks", "repair_data_permissions", "report_health", "inspect_secure_env",
