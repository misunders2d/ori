...
from .diagnostics import check_active_tasks, report_health, inspect_secure_env
...
__all__ = [
    ...
    "list_available_models", "set_agent_model",
    "check_active_tasks", "report_health", "inspect_secure_env",
